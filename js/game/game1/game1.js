...
// Текущая версия проекта не закончена. Я отдаю себе отчет в том, что в данном статусе мой проект не пройдет защиту.
// Если по какой то магической причине срок сдачи можно будет немного сдвинуть, вероятно я успею к этому времени
